        ...
        return (
            <>
                ...
                <div style={{ display: "flex" }}>
                    <div style={{ width: "50%" }}>
                        <button
onClick={this.ubahKomponenMuncul1}>{this.state.firstChild ? 'hilangkan' :
'munculkan'} komponen!</button>
                        {this.state.firstChild && <FirstChild />}
                    </div>
                    <div style={{ width: "50%" }}>
                        <button
onClick={this.ubahKomponenMuncul2}>{this.state.secondChild ? 'hilangkan' :
'munculkan'} komponen!</button>
